...
class FaceDetection:
    ...
    def __init__(self, modelpath = config.face_detection_model):
        ...
        self.retinaface_detector = RetinaFace('D:\\CSLT\Retinanet_face\\keras-retinanet\\model\\retinaface_model\\mnet.25\\mnet.25', 0, config.gpuid, 'net3')
    ...
    def update(self, raw_img):
        ...
        bboxes, landmarks0 = self.retinaface_detector.detect(raw_img, config.thresh, scales=[im_scale], do_flip=False)
        return bboxes.astype(np.int32).tolist()
